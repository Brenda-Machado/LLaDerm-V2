...
\begin{table}[ht]
    \caption{\small Métricas da classificação das lesões de pele com o \ac{LLaMA}-3.2-11B-Vision-Instruct quantizado.}
    \centering
...
\begin{figure}[ht]
    ...
    classe I denota as respostas inválidas. A legenda das lesões está na \autoref{tab:skin_lesion_classes_legend}.}
