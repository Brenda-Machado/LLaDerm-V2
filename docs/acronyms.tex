...
\siglalista{VQA}{\textit{Visual Question Answering}}
\siglalista{SAM-Med2D}{\textit{Segment Anything Model Med2D}}
\siglalista{MoE}{\textit{Mixture of Experts}}
\siglalista{PPO}{\textit{Proximal Policy Optimization}}
\siglalista{JSON}{\textit{JavaScript Object Notation}}
\siglalista{CSV}{\textit{Comma-separated values}}
\siglalistaplural{ID}{identificador}{identificadores}
\siglalista{HTML}{\textit{HyperText Markup Language}}
\siglalista{PLN}{Processamento de língua natural}
\siglalista{BLEU}{\textit{Bilingual Evaluation Understudy}}
\siglalista{ROUGE}{\textit{Recall-Oriented Understudy for Gisting Evaluation}}
\siglalista{METEOR}{\textit{Metric for Evaluation of Translation with Explicit Ordering}}
