...
sí das imagens e do texto eram consideravelmente diferentes. As imagens de aproximação utilizadas possuem uma
complexidade visual muito maior, pois elas incluem elementos extras além da lesão de pele, como o resto do ambiente ao
redor do local da lesão. Além disso, os textos utilizados possuem não só uma seção para a classificação da lesão, mas
