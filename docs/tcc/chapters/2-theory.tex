...
\subsection{Detecção e Diagnóstico de Câncer do Pele} \label{sec:skin_cancer_detection}
...
com esses problemas, como \ac{RPE}, \acf{RoPE} e vieses posicionais relativos. \textcite{llm_survey_2024} traz
...
\subsubsection{Pré-treinamento de MLLMs}
...
baseadas em \ac{PEFT}, oferecem uma forma de adaptação de modelos com um custo computacional relativamente menor. Dentre
várias técnicas, uma das mais populares é o treinamento com \ac{LoRA} \cite{llm_survey_2023}.

\subsubsubsection{LoRA}

Esta técnica, proposta por \textcite{hu2021lora}, consiste-se em explorar o \textit{rank} intrínseco, um conceito
