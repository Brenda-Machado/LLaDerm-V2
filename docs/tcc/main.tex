...
\titulo{Fine-tuning do MLLM LLaMA para a Classificação de Lesões de Pele e Geração de Laudos}
\orientador[Orientador]{Aldo von Wangenheim, Prof. Dr. rer.nat.}
\coorientador[Coorientador]{Rodrigo de Paula e Silva Ribeiro, MSc.}
\coordenador[Coordenadora]{Profa. Lúcia Helena Martins Pacheco, Dra.}
\ano{2025}
\local{Florianópolis}
...
\begin{apendicesenv}
	\partapendices* 
	\input{aftertext/repositories}
	\input{aftertext/sbc-article}
\end{apendicesenv}
